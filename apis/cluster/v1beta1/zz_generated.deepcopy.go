...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricObserveration) DeepCopyInto(out *MetricObserveration) {
	*out = *in
	if in.Data != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricObserveration.
func (in *MetricObserveration) DeepCopy() *MetricObserveration {
	if in == nil {
		return nil
	}
	out := new(MetricObserveration)
	in.DeepCopyInto(out)
	return out
}
