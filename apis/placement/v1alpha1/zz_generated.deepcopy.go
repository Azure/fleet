...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StageRollout) DeepCopyInto(out *StageRollout) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageRollout.
func (in *StageRollout) DeepCopy() *StageRollout {
	if in == nil {
		return nil
	}
	out := new(StageRollout)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *StageRollout) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StageRolloutConfig) DeepCopyInto(out *StageRolloutConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageRolloutConfig.
func (in *StageRolloutConfig) DeepCopy() *StageRolloutConfig {
	if in == nil {
		return nil
	}
	out := new(StageRolloutConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StageRolloutList) DeepCopyInto(out *StageRolloutList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]StageRollout, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageRolloutList.
func (in *StageRolloutList) DeepCopy() *StageRolloutList {
	if in == nil {
		return nil
	}
	out := new(StageRolloutList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *StageRolloutList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StageRolloutSpec) DeepCopyInto(out *StageRolloutSpec) {
	*out = *in
	if in.StageRollout != nil {
		in, out := &in.StageRollout, &out.StageRollout
		*out = make([]StageRolloutConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.WaitTimeBetweenStage != nil {
		in, out := &in.WaitTimeBetweenStage, &out.WaitTimeBetweenStage
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageRolloutSpec.
func (in *StageRolloutSpec) DeepCopy() *StageRolloutSpec {
	if in == nil {
		return nil
	}
	out := new(StageRolloutSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StageRolloutStatus) DeepCopyInto(out *StageRolloutStatus) {
	*out = *in
	if in.ClustersInCurrentStage != nil {
		in, out := &in.ClustersInCurrentStage, &out.ClustersInCurrentStage
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.CurrentUpdatingClusters != nil {
		in, out := &in.CurrentUpdatingClusters, &out.CurrentUpdatingClusters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StageRolloutStatus.
func (in *StageRolloutStatus) DeepCopy() *StageRolloutStatus {
	if in == nil {
		return nil
	}
	out := new(StageRolloutStatus)
	in.DeepCopyInto(out)
	return out
}
