...
func (in *DiffedResourcePlacement) DeepCopyInto(out *DiffedResourcePlacement) {
	*out = *in
	...
	if in.ObservedDiffs != nil {
		...
		*out = make([]JSONPatchDetail, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JSONPatchDetail) DeepCopyInto(out *JSONPatchDetail) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JSONPatchDetail.
func (in *JSONPatchDetail) DeepCopy() *JSONPatchDetail {
	if in == nil {
		return nil
	}
	out := new(JSONPatchDetail)
	in.DeepCopyInto(out)
	return out
}
