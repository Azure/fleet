...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverrideSnapshotIdentifier) DeepCopyInto(out *OverrideSnapshotIdentifier) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverrideSnapshotIdentifier.
func (in *OverrideSnapshotIdentifier) DeepCopy() *OverrideSnapshotIdentifier {
	if in == nil {
		return nil
	}
	out := new(OverrideSnapshotIdentifier)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourcePlacementStatus) DeepCopyInto(out *ResourcePlacementStatus) {
	*out = *in
	...
	if in.Overrides != nil {
		...
		*out = make([]OverrideSnapshotIdentifier, len(*in))
		copy(*out, *in)
	}
}
