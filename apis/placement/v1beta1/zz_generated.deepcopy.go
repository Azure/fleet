...
func (in *ClusterSelectorTerm) DeepCopyInto(out *ClusterSelectorTerm) {
	*out = *in
	...
	in.MetricSorter.DeepCopyInto(&out.MetricSorter)
}
...
func (in *MetricSelector) DeepCopyInto(out *MetricSelector) {
	*out = *in
	if in.MatchExpressions != nil {
		...
		*out = make([]MetricSelectorRequirement, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricSelectorRequirement) DeepCopyInto(out *MetricSelectorRequirement) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricSelectorRequirement.
func (in *MetricSelectorRequirement) DeepCopy() *MetricSelectorRequirement {
	if in == nil {
		return nil
	}
	out := new(MetricSelectorRequirement)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricSortPreference) DeepCopyInto(out *MetricSortPreference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricSortPreference.
func (in *MetricSortPreference) DeepCopy() *MetricSortPreference {
	if in == nil {
		return nil
	}
	out := new(MetricSortPreference)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricSorter) DeepCopyInto(out *MetricSorter) {
	*out = *in
	if in.SortByMetric != nil {
		in, out := &in.SortByMetric, &out.SortByMetric
		*out = make([]MetricSortPreference, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricSorter.
func (in *MetricSorter) DeepCopy() *MetricSorter {
	if in == nil {
		return nil
	}
	out := new(MetricSorter)
	in.DeepCopyInto(out)
	return out
}
