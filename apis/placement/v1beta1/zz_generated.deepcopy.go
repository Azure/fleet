...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DriftedOrDiffedResourcePlacement) DeepCopyInto(out *DriftedOrDiffedResourcePlacement) {
	*out = *in
	in.ResourceIdentifier.DeepCopyInto(&out.ResourceIdentifier)
	in.ObservationTime.DeepCopyInto(&out.ObservationTime)
	in.FirstDriftOrDiffObservedTime.DeepCopyInto(&out.FirstDriftOrDiffObservedTime)
	if in.ObservedDriftsOrDiffs != nil {
		in, out := &in.ObservedDriftsOrDiffs, &out.ObservedDriftsOrDiffs
		*out = make([]ObservedDriftOrDiffDetail, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DriftedOrDiffedResourcePlacement.
func (in *DriftedOrDiffedResourcePlacement) DeepCopy() *DriftedOrDiffedResourcePlacement {
	if in == nil {
		return nil
	}
	out := new(DriftedOrDiffedResourcePlacement)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObservedDriftOrDiffDetail) DeepCopyInto(out *ObservedDriftOrDiffDetail) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObservedDriftOrDiffDetail.
func (in *ObservedDriftOrDiffDetail) DeepCopy() *ObservedDriftOrDiffDetail {
	if in == nil {
		return nil
	}
	out := new(ObservedDriftOrDiffDetail)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourcePlacementStatus) DeepCopyInto(out *ResourcePlacementStatus) {
	*out = *in
	...
	if in.DriftedOrDiffedPlacements != nil {
		in, out := &in.DriftedOrDiffedPlacements, &out.DriftedOrDiffedPlacements
		*out = make([]DriftedOrDiffedResourcePlacement, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
