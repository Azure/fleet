...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricMatcher) DeepCopyInto(out *MetricMatcher) {
	*out = *in
	if in.Ranges != nil {
		in, out := &in.Ranges, &out.Ranges
		*out = make([]MetricRange, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricMatcher.
func (in *MetricMatcher) DeepCopy() *MetricMatcher {
	if in == nil {
		return nil
	}
	out := new(MetricMatcher)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricRange) DeepCopyInto(out *MetricRange) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricRange.
func (in *MetricRange) DeepCopy() *MetricRange {
	if in == nil {
		return nil
	}
	out := new(MetricRange)
...
func (in *MetricSelector) DeepCopyInto(out *MetricSelector) {
	*out = *in
	if in.MatchMetrics != nil {
		in, out := &in.MatchMetrics, &out.MatchMetrics
		*out = make([]MetricMatcher, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
