...
type GenerateAttributeBasedRecommendationsRequest struct {
	...
	RegularPriorityProfile *RegularPriorityProfile `protobuf:"bytes,3,opt,name=regular_priority_profile,json=regularPriorityProfile,proto3" json:"regular_priority_profile,omitempty"`
	// Object of VMPriorityProfile for spot vms.
	SpotPriorityProfile *SpotPriorityProfile `protobuf:"bytes,4,opt,name=spot_priority_profile,json=spotPriorityProfile,proto3" json:"spot_priority_profile,omitempty"`
	// optional
