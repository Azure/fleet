...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControllerManagerCondition) DeepCopyInto(out *ControllerManagerCondition) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControllerManagerCondition.
func (in *ControllerManagerCondition) DeepCopy() *ControllerManagerCondition {
	if in == nil {
		return nil
	}
	out := new(ControllerManagerCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InternalMemberClusterStatus) DeepCopyInto(out *InternalMemberClusterStatus) {
	*out = *in
	...
	if in.ControllerManagerConditions != nil {
		in, out := &in.ControllerManagerConditions, &out.ControllerManagerConditions
		*out = make([]ControllerManagerCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
