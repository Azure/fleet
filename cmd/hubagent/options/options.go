...
type Options struct {
	...
	EnableWebhook bool
	// EnableDenyWebhook indicates if we will enable deny validating webhook configurations.
...
func (o *Options) AddFlags(flags *flag.FlagSet) {
	...
	flag.BoolVar(&o.EnableDenyWebhook, "enable-deny-webhook", false, "If set, the fleet deny validating webhook configurations are enabled.")
