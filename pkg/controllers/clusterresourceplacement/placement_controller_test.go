...
func placementPolicyForTest() *fleetv1.PlacementPolicy {
	return &fleetv1.PlacementPolicy{
		PlacementType:    fleetv1.PickNPlacementType,
...
func clusterResourcePlacementForTest() *fleetv1.ClusterResourcePlacement {
	return &fleetv1.ClusterResourcePlacement{
		ObjectMeta: metav1.ObjectMeta{
			Name: testName,
		},
		Spec: fleetv1.ClusterResourcePlacementSpec{
			...
			policySnapshots: []fleetv1.ClusterPolicySnapshot{
				{
					ObjectMeta: metav1.ObjectMeta{
						...
						Labels: map[string]string{
							...
							fleetv1.CRPTrackingLabel:      "another-crp",
						},
					},
				},
			},
