...
func TestMarkMemberClusterJoined(t *testing.T) {
	...
	expectedConditions := []metav1.Condition{
		{Type: string(fleetv1alpha1.ConditionTypeMemberClusterJoin), Status: metav1.ConditionTrue, Reason: reasonMemberClusterJoined},
	}
...
func TestSyncInternalMemberClusterStatus(t *testing.T) {
	...
	for testName, tt := range tests {
		t.Run(testName, func(t *testing.T) {
			...
			assert.Equal(t, "", cmp.Diff(tt.wantedMemberCluster.GetCondition(string(fleetv1alpha1.ConditionTypeMemberClusterJoin)), tt.memberCluster.GetCondition(string(fleetv1alpha1.ConditionTypeMemberClusterJoin)), cmpopts.IgnoreTypes(time.Time{})))
