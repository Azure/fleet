			...
			wantConditions: []metav1.Condition{
				{
					...
					Status:             metav1.ConditionUnknown,
					Reason:             "RolloutControlledByExternalController",
					Message:            "Rollout is controlled by an external controller and no resource snapshot name is observed across clusters. To determine rollout status, check the ClusterStagedUpdateRun resources with spec.placementName matching this placement",
					ObservedGeneration: 1,
				},
			},
			wantErr: false,
