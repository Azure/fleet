...
var _ = Describe("Test the StagedUpdateRun Controller", func() {
	...
	BeforeEach(func() {
		...
		updateStrategy = &placementv1alpha1.StagedUpdateStrategy{
			ObjectMeta: metav1.ObjectMeta{
		...
		updateRun = &placementv1alpha1.StagedUpdateRun{
			ObjectMeta: metav1.ObjectMeta{
				Name:      testUpdateRunName,
				Namespace: "default",
			},
			Spec: placementv1alpha1.StagedUpdateRunSpec{
				PlacementRef: placementv1alpha1.PlacementReference{
					Name: testCRPName,
				},
				ResourceSnapshotIndex: masterSnapshot.Name,
				StagedUpdateStrategyRef: placementv1beta1.NamespacedName{
					Name:      testUpdateStrategyName,
					Namespace: "default",
				},
			},
...
func verifyFailedInitCondition(updateRun *placementv1alpha1.StagedUpdateRun, message string) error {
	var latestUpdateRun placementv1alpha1.StagedUpdateRun
...
func validateSuccessfulInitStatus(updateRun *placementv1alpha1.StagedUpdateRun, policySnapshotIndexUsed string,
	policyObservedNodeCount int, applyStrategy *placementv1beta1.ApplyStrategy, stagedUpdateStrategySnapshot *placementv1alpha1.StagedUpdateStrategySpec,
	...
	expectedStatus := placementv1alpha1.StagedUpdateRunStatus{
		...
		PolicyObservedNodeCount:      policyObservedNodeCount,
