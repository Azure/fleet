...
type PostBatchPlugin interface {
	...
	PostBatch(ctx context.Context, state CycleStatePluginReadWriter, policy *fleetv1alpha1.ClusterPolicySnapshot) (size int, status *Status)
}
...
type PreFilterPlugin interface {
	...
	// * An InternalError status, if an expected error has occurred
	PreFilter(ctx context.Context, state CycleStatePluginReadWriter, policy *fleetv1alpha1.ClusterPolicySnapshot) (status *Status)
}
...
type FilterPlugin interface {
	...
	// * An InternalError status, if an expected error has occurred
	Filter(ctx context.Context, state CycleStatePluginReadWriter, policy *fleetv1alpha1.ClusterPolicySnapshot, cluster *fleetv1alpha1.MemberCluster) (status *Status)
}
...
type PreScorePlugin interface {
	...
	// * An InternalError status, if an expected error has occurred
	PreScore(ctx context.Context, state CycleStatePluginReadWriter, policy *fleetv1alpha1.ClusterPolicySnapshot) (status *Status)
}
...
type ScorePlugin interface {
	...
	// * An InternalError status, if an expected error has occurred
	Score(ctx context.Context, state CycleStatePluginReadWriter, policy *fleetv1alpha1.ClusterPolicySnapshot, cluster *fleetv1alpha1.MemberCluster) (score *ClusterScore, status *Status)
}
