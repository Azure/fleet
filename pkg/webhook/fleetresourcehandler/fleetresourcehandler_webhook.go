...
func (v *fleetResourceValidator) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	if req.Operation == admissionv1.Create || req.Operation == admissionv1.Update || req.Operation == admissionv1.Delete {
		...
		case req.Kind == utils.V1Alpha1MCGVK:
		...
		case req.Kind == utils.V1Alpha1IMCGVK || req.Kind == utils.V1Alpha1WorkGVK || req.Kind == utils.IMCGVK || req.Kind == utils.WorkV1Beta1GVK || req.Kind == utils.EndpointSliceExportGVK || req.Kind == utils.EndpointSliceImportGVK || req.Kind == utils.InternalServiceExportGVK || req.Kind == utils.InternalServiceImportGVK:
